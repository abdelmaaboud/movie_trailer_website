# import fresh_tomatoes to render html page
...
blood_diamond = Movie(
    "Blood Diamond",
    " A fisherman, a smuggler, and a syndicate of \
    businessmen match wits over the possession of a priceless diamond. ",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMjIwNDEzNTY2NV5BMl5BanBnXkFtZTgwNjAyMDAxMzE@._V1_.jpg",  # NOQA
    "https://www.youtube.com/watch?v=XtPX2kXhu7I")

django = Movie(
    "Django Unchained",
    " A fisherman, a smuggler, and a syndicate of \
    businessmen match wits over the\
     possession of a priceless diamond. ",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMjIyNTQ5NjQ1OV5BMl5BanBnXkFtZTcwODg1MDU4OA@@._V1_SY1000_CR0,0,674,1000_AL_.jpg",  # NOQA
    "https://www.youtube.com/watch?v=eUdM9vrCbow")

revenant = Movie(
    "the revenant",
    " A frontiersman on a fur trading expedition in the 1820s\
     fights for survival after being mauled by a bear and left\
      for dead by members of his own hunting team. ",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BY2FmODc2N2QtYmY3MS00YTMwLWI2NGYtZWRmYWVkNjFjZmI0XkEyXkFqcGdeQXVyNTMxMjgxMzA@._V1_.jpg",  # NOQA
...
# use this list as input to generate html file
